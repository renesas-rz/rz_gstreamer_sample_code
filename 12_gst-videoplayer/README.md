...
-	 Variable `video_parser (GstElement)`: A GStreamer element to parse H.264/H.265 stream to AVC/HEVC format which omxh264dec/omxh265dec can recognize and process.
-	 Variable `video_decoder (GstElement)`: A GStreamer element to decompress H.264/H.265 stream to raw NV12-formatted video.
